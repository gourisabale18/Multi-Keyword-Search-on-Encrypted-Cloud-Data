    ...
    if(request.getParameter("BtnSub")!=null)
        {
            ...
            obj.setUtype("datauser");
            msg=obj.execute();
            if(msg.equals("success"))
                {
                  String uploadPath="d://download/"+unm;
...
<body>
 ...
 <form id="formID">
                            ...
                            <tr><td align="center" colspan="2" style="color: gray"><font face="verdana" size="8"><b>User Register</b></font></h1></td></tr>
